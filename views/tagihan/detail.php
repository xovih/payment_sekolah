  ...
  <section class="section">
    <div class="section-header">
      ...
      <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item">Update Tagihan</div>
      </div>
    </div>

    <div class="section-body" id="dashboard-data">
      <h2 class="section-title">Update Tagihan</h2>
      <p class="section-lead">
        Update Tagihan ini digunakan untuk Mengubah Data tagihan / kewajiban siswa.
      </p>
              ...
              <div class="row">
                <div class="col-12 col-lg-6">
                  <div class="form-group">
                    ...
                    <input type="hidden" name="id_tagihan" id="formulir-id_tagihan"/>
                  </div>
                </div>
                <div class="col-12 col-lg-6">
                  <div class="form-group">
            ...
            <div class="card-footer text-right">
              <nav class="d-inline-block">
                <ul class="pagination mb-0" id="pagination-wraper">
                  <li class="mr-3">
                    <a href="#" class="btn btn-danger" id="formulir-hapus">
                      <i class="fa fa-trash"></i> Hapus Tagihan
                    </a>
                  </li>
                  <li class="active">
                    <a href="#" class="btn btn-primary" id="formulir-update">
                      <i class="fa fa-save"></i> Update Tagihan
                    </a>
                  </li>
                </ul>
              </nav>
...
<script>
  ...
  newTransaction()
  const id_tagihan = <?=$id_tagihan;?>;
  getTagihanTerpilih(id_tagihan);
</script>